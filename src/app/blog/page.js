    ...
    <div className="overflow-y-hidden">
      <DashboardLayout>
              ...
              <Error message={error.message} />
                ...
                <>
              <h1 className="p-3 bg-black text-white capitalize text-2xl font-semibold ">
              BLOG
              </h1>
