...
import Modal from "../modal_blog/page";
...
export default function page({data}) {
    ...
    switch (columnKey) {
      ...
      case "category":
        ...
        case "date_of_publish":
          return (
            <div className="flex flex-col">
              <p className="text-bold text-medium capitalize">{convertDate(cellValue)}</p>
              {/* <p className="text-bold text-tiny capitalize text-default-500">{user.team}</p> */}
            </div>
          );
      ...
      case "active_deactive":
        ...
        return (
          <div className="relative flex justify-center items-center gap-2">
            <Dropdown aria-label="dropdown" className="bg-[#0e0f12] text-[#ffffffa3] border-0 border-default-200">
              <DropdownTrigger>
  ...
  return (
    <>
     <Modal isOpen={isOpen} onOpenChange={onOpenChange} props={state_id} />
     <Table
      id="blog_style"
