...
if(props.props){
   console.log('props.blog_by',props)
    ...
    set_blog_content(props.props.discription)
      ...
      >
        <ModalContent>
          {(onClose) => (
            <>
              ...
              <div className="flex flex-col w-full pr-4">
                 ...
                 <input
                  ...
                  />
                  <Avatar
                    className="mb-4 mt-1 object-cover  cursor-pointer w-28 h-28 text-large"
            ...
            <div className="w-[25%] pr-4">
            <h4 className="text-[#ffffffa3] text-sm my-4">Type <span className="text-red-700 p-1">*</span></h4>
                  <select
                      className="bg-[#00000040] subscription_select  text-[#ffffffa3] w-full h-12 p-2 rounded-lg outline-none"
            ...
            <div className="w-[25%] pr-4">
            <h4 className="text-[#ffffffa3] text-sm my-4">Price <span className="text-red-700 p-1">*</span></h4>
              <input
                type="text"
                name="title"
                label="Title"
          ...
          <h4 className="text-[#ffffffa3] text-sm my-4"> Subscription Details <span className="text-red-700 p-1">*</span></h4>
