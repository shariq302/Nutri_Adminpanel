...
const INITIAL_VISIBLE_COLUMNS = ["title", "recruiter", "country", "job_type", "date", "salary_range", "experience", "expired"];
      ...
      case "expired":
        return (
          <Chip
            ...
            color={statusColorMap[user.expired]}
            size="md"
            variant="flat"
          >
            {user.expired?'Active':'Expired'}
          </Chip>
        );
      default:
        return cellValue;
