...
const INITIAL_VISIBLE_COLUMNS = ["name", "email", "category", "subscription_duration", "subscription_start_date", "subscription_end_date" , "subscription_payment" ,"verification_subscription"];
...
export default function page({data}) {
  ...
  const renderCell = React.useCallback((user, columnKey) => {
    ...
    switch (columnKey) {
      ...
      case "verification_subscription":
        return (
          <div className="relative flex justify-start  items-center gap-2 pl-3">
            <FiUserCheck color="green" size={22} />
            {/* <p className="text-bold text-medium capitalize"> Verified</p> */}
          </div>
        );
      default:
        return cellValue;
