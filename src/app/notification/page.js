...
import Notifications_table from "../component/notifications_table/page";
import Notifications_form from "../component/notifications_form/page";
import axios from "axios";
import { useQuery } from "react-query";
import Loading from '../component/loader/page'
import Error from '../component/error_page/page'
import { useMyContext } from "../context";
import notification from './notification.json'; // Import the JSON file
...
function page() {
  ...
  const data = notification.data; // Assuming your JSON structure has a 'data' key
  const handleExport = () => {
    ...
    <div className="overflow-y-hidden">
      <DashboardLayout>
          ...
          <div className="mt-4 flex gap-4 justify-between  border-none p-3 rounded-ss-xl rounded-se-xl bg-[#0E0F12] w-72 2xl:w-auto xl:w-auto lg:w-auto md:w-auto sm:w-9/12 ">
                <p className="text-white pt-2 capitalize font-semibold text-xl">
                View Notifications
                </p>
