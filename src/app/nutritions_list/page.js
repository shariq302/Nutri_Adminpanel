...
import Nutrition_table from "../component/nutritionist_table/page";
...
import Nutri_List from './nutrition_list.json'
...
function Page() {
  ...
  const data = Nutri_List.data; // Assuming your JSON structure has a 'data' key
