...
import ProUsers_table from "../component/proUsers_table/page";
    ...
    async function retrieveData() {
      try {
        const response = await axios.get(
          `${api}/user_management/list_nutritionist/`,
          { headers }
        );
        console.log('Pro User Data ---- ', response.data.users)
