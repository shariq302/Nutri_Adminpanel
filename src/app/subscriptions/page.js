...
import Subscriptions_table from "../component/subscriptions_table/page";
import Subscriptions_form from "../component/subscriptions_form/page";
import axios from "axios";
import { useQuery } from "react-query";
import Loading from '../component/loader/page'
import Error from '../component/error_page/page'
import { useMyContext } from "../context";
import subscriptions from './subscriptions.json'; // Import the JSON file
...
function page() {
  ...
  const data = subscriptions.data; // Assuming your JSON structure has a 'data' key
  const handleExport = () => {
    ...
    <div className="overflow-y-hidden">
      <DashboardLayout>
              ...
              <Error message={error.message} />
                ...
                <>
              <h1 className="p-3 bg-black text-white capitalize font-semibold text-2xl ">
               Subscriptions
              </h1>
          ...
          <div className="mt-4 flex gap-4 justify-between  border-none p-3 rounded-ss-xl rounded-se-xl bg-[#0E0F12] w-72 2xl:w-auto xl:w-auto lg:w-auto md:w-auto sm:w-9/12 ">
                <p className="text-white pt-2 capitalize text-semibold text-xl">
                View Subscriptions
                </p>
